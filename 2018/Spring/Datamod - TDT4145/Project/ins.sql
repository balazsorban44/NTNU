...
USE project;
CREATE TABLE treningsøkt(ID INT NOT NULL,
  dato DATE,
  tidspunkt TIME,
  varighet INT,
...
CREATE TABLE notat(ID INT NOT NULL,
  treningsformål TEXT,
...
CREATE TABLE apparat(ID INT NOT NULL,
  navn VARCHAR(30),
  bruksanvisning TEXT,
  CONSTRAINT apparat_pk PRIMARY KEY (ID)
);
CREATE TABLE øvelse(ID INT NOT NULL,
  navn VARCHAR(30),
  kilo INT,
  sett INT,
  beskrivelse TEXT,
...
CREATE TABLE øvelsegruppe(ID INT NOT NULL,
  navn VARCHAR(30),
